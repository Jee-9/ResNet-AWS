...
"""
mb_list 불러오는 코드 ( 영상 snapshot 추출)
"""
...
mb_list = glob.glob('/content/drive/MyDrive/Youtube_API/Mukbang/*.webm') ### 경로 변경
...
for index, vid in enumerate(mb_list):
  try:
    ...
    while(cap.isOpened()):
      ...
      if sample_num == 60:
        captured_num += 1
        cv2.imwrite('/content/drive/MyDrive/Youtube_API/Mukbang_img/'+ str(index) + '_' +str(captured_num) + '.jpg', frame) # 경로 변경 
        sample_num = 0
