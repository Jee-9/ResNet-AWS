...
# 문복희 Eat with Boki channelID  가져오는 코드

channelID = "UCoLQZ4ZClFqVPCvvjuiUSRA"

mukbang = Channel(channelID)
video1, channels1, playlists1 = mukbang.youtube_search()

video1_id_list = list(video1.values())

# video1 _ 문복희 먹방

for i in range(len(video1_id_list)):
  ytb_url = "https://www.youtube.com/watch?v="
  video_id = video1_id_list[i]
  ...
  for s in streams:
    s.download('/content/Youtube_API/Game')
