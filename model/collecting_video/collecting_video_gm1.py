...
video3, channels3, playlists3 = game.youtube_search()


video3_id_list = list(video3.values())


# video3 _ 페이커 게임

for i in range(len(video3_id_list)):
  ytb_url = "https://www.youtube.com/watch?v="
  video_id3 = video3_id_list[i]
  vid_url = ytb_url + video_id3
