...
channelID = "UCpf2KBclcdxmNhpGTlxJpsQ"

game2 = Channel(channelID)
video4, channels4, playlists4 = game2.youtube_search()


video4_id_list = list(video4.values())


# video4 _ 곰돌이 게임

for i in range(len(video4_id_list)):
  ytb_url = "https://www.youtube.com/watch?v="
  video_id4 = video4_id_list[i]
  vid_url = ytb_url + video_id4
